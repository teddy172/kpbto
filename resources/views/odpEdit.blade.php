    ...
    <div class="kartu">
        ...
        <form Action="{{url('/odp/'.$data->odp_id)}}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nama_odp" aria-describedby="emailHelp" value="{{ $data->nama_odp}}">
            </div>
            <div class="mb-3">
                <label for="floatingTextarea2">Lokasi</label>
                <textarea class="form-control" placeholder="ketik lokasi ODP" name="lokasi" style="height: 100px">{{ $data->lokasi}}</textarea>
            </div>
            <div class="mb-3">
