    ...
    <div class="data-container">
        <div class= "bio-container">
            ...
            <div class="tab-content
                ...
                {{-- Profile Page --}}
                <div class="tab tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        ...
                        <div class="row text">
                            <div class="column">
                                ...
                                <input type="text" class="form-control" id="NAMA" aria-describedby="emailHelp"
                                    style="height: 50px" value="{{ $pass->name }}" name="name">
                            ...
                            <div class="column">
                                ...
                                <input type="text" class="form-control" id="NO-TELEPON" aria-describedby="emailHelp"
                                    style="height: 50px" value="{{ $pass->nomer_telepon }}" name="nomer_telepon">
                            </div>
                        </div>
                        <div class="row text">
                            <div class="column">
                                ...
                                <input type="text" class="form-control" id="NIP" aria-describedby="emailHelp"
                                    style="height: 50px" value="{{ $pass->NIP }}" name="NIP">
                            </div>
                            <div class="column">
                                <label for="EMAIL" class="form-label">EMAIL</label>
                                <input type="email" class="form-control" id="EMAIL"
                                    aria-describedby="emailHelp"style="height: 50px" value="{{ $pass->email }}" name="email">
                            </div>
                        </div>
                        <div class="row">
                ...
                <form action="{{ url('/keamanan/'.$pass->id) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="row text">
                            <div class="column">
                                ...
                                <input type="text" class="form-control" id="Pass-lam" aria-describedby="emailHelp"
                                    style="height: 50px" name="pass_lama">
                            </div>
                            <div class="column">
                                ...
                                <input type="text" class="form-control" id="Pass-bar" aria-describedby="emailHelp"
                                    style="height: 50px" name="pass_baru">
                            </div>
                    </div>
