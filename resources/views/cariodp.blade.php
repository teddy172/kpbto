...
<head>
    ...
    <title>Cari ODP</title>
    <link rel="stylesheet" type="text/css" href="../css/cariodp.css">
...
<body>
    ...
    <div class="search-bar-container">
        <div class="input-group mb-3" id="search-bar">
            <form role="search" Action="{{ url('/ODP/cari') }}" class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Masukkan Kode ODP" aria-describedby="button-addon2"
        ...
        <div class="row">
            ...
            <div class="col">
                <a href="{{url('/ODP/create')}}">
                    <button type="button" class="btn btn-lg" id="text" style="background: #D9D9D9">+TAMBAH</button>
                </a>
            </div>
        </div>
    </div>
